...
public class LieuRepository extends Repository {
	...
	public void creer() {
		...
		List<Integer> selectNumber = Arrays.asList(1, 2, 3);
				System.out.println("Quelle type de Lieu voulez vous créer?\n"+ clientMenuString);
				boolean toTheNextStep = true;
				while(toTheNextStep) {
					try {
						selection = Integer.parseInt(userInput.next());
	...
	public void modifier() {
		System.out.println("Veuillez selectioner le numéro du lieu à modifier:");
	...
	public void supprimer() {
		System.out.println("Veuillez selectioner le numéro du lieu à supprimer:");
		...
		else System.out.println("Suppression annulée.");
	}
